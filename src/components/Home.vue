  ...
  <div>
    ...
    <section class="hero">
      <div class="hero-text">
        ...
        <p>
          Premium Lubricants, Batteries, Filters & Tires – Built to Power Your World.
        </p>

        <div class="hero-btns">
          <button class="btn-explore" @click="exploreProducts">
            EXPLORE PRODUCTS →
          </button>

          <button class="btn-outline" @click="handleQuote">
            GET A QUOTE
          </button>
        </div>
      </div>
